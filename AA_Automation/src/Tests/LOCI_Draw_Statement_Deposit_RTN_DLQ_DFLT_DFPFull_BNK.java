...
public class LOCI_Draw_Statement_Deposit_RTN_DLQ_DFLT_DFPFull_BNK {
	...
	public synchronized void initialize() {
		...
		String filename="AA_LOC_RegressionScenario_Scenario.No_128_"+timestamp+".html";

		reports = new ExtentReports(System.getProperty("user.dir") + "/ExecutionReports/LOC/AA_LOC_RegressionScenarios_/AA_LOC_RegressionScenario_Scenario.No_128_/"+filename, true);
	}
		...
		{	
			...
			//driver.manage().window().maximize();
		       ...
		       // System.out.println(Password);
		        ...
		        test = reports.startTest(Header+"_S.No:128_"+PayFrequency+"_"+CollateralType, "LOCI _ Draw _ Statement_ Deposit _RTN_DLQ _DFLT_DFP Full_BNK _NO VOID DFP Void Should not displayed after DFP");
		        Assert.assertTrue(true);
		        appUrl = AppURL;
