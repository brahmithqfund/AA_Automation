...
public class LOCI_Draw_BNKIntrstCalcShuldhappen_LoanShouldDefOrWOB_WO_WORFull_VoidWOR {
	...
	public synchronized void initialize() {
		...
		String filename="AA_LOC_RegressionScenario_Scenario.No_125_"+timestamp+".html";

		reports = new ExtentReports(System.getProperty("user.dir") + "/ExecutionReports/LOC/AA_LOC_RegressionScenarios_/AA_LOC_RegressionScenario_Scenario.No_125_/"+filename, true);
	}
		...
		{	
			...
			//driver.manage().window().maximize();
		       ...
		       // System.out.println(Password);
		        ...
		        test = reports.startTest(Header+"_S.No:125_"+PayFrequency+"_"+CollateralType, "LOCI _ Draw _ Statement _ BNK Intrst Calc Shuld happen=>Loan to def/WOB _WO _WOR Full _Void WOR full");
		        Assert.assertTrue(true);
		        appUrl = AppURL;
		        ...
		        this.DrawLoan(SSN, FileName);
			       ...
			       this.StatementGeneration_Interest(SSN, FileName);
