...
public class LOCI_Draw_Stmt_Depo_RTN_DLQ_DFLT_RPP_BNKPDL_RPPFull_CheckStatus {
	...
	public synchronized void initialize() {
		...
		String filename="AA_LOC_RegressionScenario_Scenario.No_131_"+timestamp+".html";

		reports = new ExtentReports(System.getProperty("user.dir") + "/ExecutionReports/LOC/AA_LOC_RegressionScenarios_/AA_LOC_RegressionScenario_Scenario.No_131_/"+filename, true);
	}
...
/*	public synchronized void initialize() {
		...
		String filename="AA_LOC_RegressionScenario_Scenario.No_130_"+timestamp+".html";

		reports = new ExtentReports(System.getProperty("user.dir") + "/ExecutionReports/LOC/AA_LOC_RegressionScenarios_/AA_LOC_RegressionScenario_Scenario.No_130_/"+filename, true);
	}*/
	@BeforeTest
...
@Test (priority=0)
 ...
 public void LOCI_Draw_Stmt_Depo_RTN_DLQ_DFLT_RPP_BNKPDL_RPPFull_CheckStatus() throws Exception {
	...
	{	
		...
		//driver.manage().window().maximize();
	       ...
	       // System.out.println(Password);
	        ...
	        test = reports.startTest(Header+"_S.No:130_"+PayFrequency+"_"+CollateralType, "LOCI _ Draw _ Statement_ Deposit _RTN_DLQ _DFLT_RPP_ BNK Other PDL Loan_RPP Full _ check loan cust status");
	        Assert.assertTrue(true);
	        appUrl = AppURL;
	        ...
	        this.AgeStore_1(SSN, FileName, -1);
		    ...
		    this.NACHA_1(SSN, FileName, -1);
		    this.ACH_Deposit_1(SSN, FileName, 0);
	        ...
	        this.RCCRevoke_1(SSN, FileName);
	        this.RPP_1(SSN, FileName);
	        this.RPP_Status_1(SSN, FileName);
	        this.Bankrupt(SSN, FileName);
        	this.RPP_Payment_1(SSN, FileName);
	     
        	this.RPP_Void(SSN, FileName);
	
	        this.BankruptStatus_1(SSN, FileName);
	        this.RPP_Status_1(SSN, FileName);
	...
	{	
		...
		//driver.manage().window().maximize();
	       ...
	       // System.out.println(Password);
			...
			String Header = StateID+ "_" + ProductID;
	        //System.out.println(SSN);
	        test = reports.startTest(Header+"_S.No:131_"+PayFrequency+"_"+CollateralType, "LOCI _ Draw _ Statement_ Deposit _RTN_DLQ _DFLT_RPP_ BNK Other PDL Loan_RPP Full _Void RPP check loan cust status");
	        Assert.assertTrue(true);
	        appUrl = AppURL;
