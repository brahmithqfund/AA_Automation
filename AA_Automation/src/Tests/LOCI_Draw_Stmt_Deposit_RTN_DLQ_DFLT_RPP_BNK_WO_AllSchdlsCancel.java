...
public class LOCI_Draw_Stmt_Deposit_RTN_DLQ_DFLT_RPP_BNK_WO_AllSchdlsCancel {
	...
	public synchronized void initialize() {
		...
		String filename="AA_LOC_RegressionScenario_Scenario.No_129_"+timestamp+".html";

		reports = new ExtentReports(System.getProperty("user.dir") + "/ExecutionReports/LOC/AA_LOC_RegressionScenarios_/AA_LOC_RegressionScenario_Scenario.No_129_/"+filename, true);
	}
