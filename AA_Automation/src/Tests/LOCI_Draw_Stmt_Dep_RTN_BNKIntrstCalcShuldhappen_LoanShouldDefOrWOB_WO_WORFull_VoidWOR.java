...
public class LOCI_Draw_Stmt_Dep_RTN_BNKIntrstCalcShuldhappen_LoanShouldDefOrWOB_WO_WORFull_VoidWOR {
	...
	public synchronized void initialize() {
		...
		String filename="AA_LOC_RegressionScenario_Scenario.No_126_"+timestamp+".html";

		reports = new ExtentReports(System.getProperty("user.dir") + "/ExecutionReports/LOC/AA_LOC_RegressionScenarios_/AA_LOC_RegressionScenario_Scenario.No_126_/"+filename, true);
	}
